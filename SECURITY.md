# Security Policy: Data Clean Room Sheets
...
- For this product's domain, review these gates before handoff: Required columns present, Allowed values enforced, Provenance required.
