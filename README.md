...
# ⚡ Data Clean Room Sheets

### Spreadsheet templates for cleaning small-business data before any automation or analysis.
...
**AI & Automation** · **Repo 39/50** · **No backend. No login. Client data stays local.**

[Live app](https://volta-npo.github.io/39-data-clean-room-sheets/) · [Report an issue](https://github.com/volta-npo/39-data-clean-room-sheets/issues) · [Volta](https://voltanpo.org)
...
**Data Clean Room Sheets** is a polished, local-first open-source tool from Volta's 50-project OSS division. It helps Finance, marketing, and AI students handling messy client data turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
...
Messy spreadsheets break automations and produce bad insights.

### The niche

Low-tech data readiness for local businesses.

### North-star metric

`datasets passing readiness checks`
...
flowchart LR
    subgraph Modules["First-class modules"]
        M1["Contact cleanup sheet"]
        M2["Sales data schema"]
        M3["Error flag columns"]
        M4["Privacy handling notes"]
    end
    M1 --> Workbench
    M2 --> Workbench
    M3 --> Workbench
...
sequenceDiagram
    ...
    participant T as Data Clean Room Sheets
...
|---|---|
| **Domain workbench** | A purpose-built data cleaner interface for spreadsheet templates for cleaning small-business data before any automation or analysis. |
...
|---:|---|---|
| 1 | **Contact cleanup sheet** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 2 | **Sales data schema** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 3 | **Error flag columns** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 4 | **Privacy handling notes** | Converts field work into repeatable, reviewable Volta delivery evidence. |
...
```bash
git clone https://github.com/volta-npo/39-data-clean-room-sheets.git
cd 39-data-clean-room-sheets
npm test
npm start
```
