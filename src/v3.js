export const v3 = {
    "productName": "Data Clean Room Sheets",
    "productTier": "release",
    ...
    "capabilities": [
        "Domain-specific workbench: Data Cleaning Lab",
        "Operational table: Dataset schema",
    ...
    "releaseChecklist": [
        ...
        "Data Readiness reaches production threshold",
        "Missingness is documented with evidence",
        "Format Validity has no unresolved blocker",
        "Cleaned CSV verified",
        "Error report verified",
